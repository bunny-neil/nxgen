 ...
 */
package nxgen.kafka.client.event.avro;
...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7186422613087384155L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Event\",\"namespace\":\"nxgen.kafka.client.event.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"sender\",\"type\":[\"null\",\"bytes\"]},{\"name\":\"payload\",\"type\":[\"null\",\"bytes\"]},{\"name\":\"dateCreated\",\"type\":\"long\"}]}");
   ...
   */
  public static nxgen.kafka.client.event.avro.Event.Builder newBuilder() {
    return new nxgen.kafka.client.event.avro.Event.Builder();
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static nxgen.kafka.client.event.avro.Event.Builder newBuilder(nxgen.kafka.client.event.avro.Event.Builder other) {
    return new nxgen.kafka.client.event.avro.Event.Builder(other);
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static nxgen.kafka.client.event.avro.Event.Builder newBuilder(nxgen.kafka.client.event.avro.Event other) {
    return new nxgen.kafka.client.event.avro.Event.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nxgen.kafka.client.event.avro.Event.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nxgen.kafka.client.event.avro.Event other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder setSender(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder clearSender() {
      sender = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder setPayload(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder setDateCreated(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nxgen.kafka.client.event.avro.Event.Builder clearDateCreated() {
